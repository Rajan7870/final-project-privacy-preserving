     ...
     <center>  <h2>User Details</h2></center>
            ...
            <form name="form1" action="creategroup" method="post">
                <center> <table border="2" style="width: 50%">
                    <tr><th style="text-align: center">Name</th><th style="text-align: center">Email</th><th style="text-align: center">Gender</th><th style="text-align: center">Mobile</th></tr>
                    <%while(rs1.next()){%>
                    <tr><td style="text-align: center"><%=rs1.getString(1)%></td><td style="text-align: center"><%=rs1.getString(2)%><td style="text-align: center"><%=rs1.getString(4)%></td><td style="text-align: center"><%=rs1.getString(5)%></td></td></tr>
                    <%}%>
