		...
		<ul class="actions">
          <%
            ...
            if(!rs1.next()){
                ...
                ResultSet rs2=st1.executeQuery("select * from groups");
            %>
            <form name="form1" action="Joingroup" method="post">
            <table><tr><td style="text-align: center">Select the Group you want to Join </td><td style="text-align: center"><select name="group"><option value="0">--Select--</option>
                            <%while(rs2.next()){%>
                            <option value="<%=rs2.getString(1)%>"><%=rs2.getString(2)%></option><%}%>
                        </select></td></tr>
                <tr><td colspan="2" style="text-align: center"><input type="submit" value="Join Group"></td></tr>
            </table>
            ...
            {           
                        %>
                        <center>   <font style="color: red">You are already in a Group. Leave Group, and Try again.</font></center>
